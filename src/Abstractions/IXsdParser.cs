...
/// <summary>
/// Parses XSD content from supported source forms into a normalized metadata graph.
/// </summary>
public interface IXsdParser
{
    ...
    /// <summary>
    /// Parses XSD content from a stream.
    /// </summary>
    ...
    /// <summary>
    /// Parses XSD content from a memory buffer.
    /// </summary>
    ...
    /// <summary>
    /// Parses XSD content from a batch of logical sources.
    /// </summary>
